...
Здесь рассмотрим первый порождающий фактор – `Singleton`.  
...
> И только в этом случае стоит использовать этот паттерн порождающего фактора.  

Для реализации такого паттерна можно привести примеры:  
– в интернет-магазине – это корзина, или **карта** клиента  
– мультимедийная система – это может быть инстанс плейера  
– ...
